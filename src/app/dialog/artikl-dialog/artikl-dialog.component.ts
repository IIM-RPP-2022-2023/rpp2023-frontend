...
export class ArtiklDialogComponent {
  ...
  public add(): void {
    ...
    this.snackBar.open('Uspešno dodat artikl ' + this.data.naziv, 'U redu', {duration: 2000});
  }

  public update(): void {
    this.artiklService.updateArtikl(this.data);
    this.snackBar.open('Uspešno izmenjen artikl ' + this.data.naziv, 'U redu', {duration: 2000});
  }
